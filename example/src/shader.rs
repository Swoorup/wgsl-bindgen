...
//
// ^ wgsl_bindgen version 0.6.0
// Changes made to this file will not be saved.
// SourceHash: dd080099970a161f32c2b02f302c01dd2a4d1c7fa38b7259a9971f5b385b88e9
...
pub mod types {
    ...
    impl VectorsF32 {
        pub fn new(a: [f32; 2], b: glam::Vec3A, c: glam::Vec4) -> Self {
            Self {
                a,
    ...
    impl Nested {
        pub fn new(a: _root::types::MatricesF32, b: _root::types::VectorsF32) -> Self {
            Self { a, b }
        }
    }
...
pub mod testbed {
    ...
    impl Uniforms {
        pub fn new(color_rgb: glam::Vec4, scalars: _root::types::Scalars) -> Self {
            Self {
                color_rgb,
                scalars,
...
struct RtsStructX_naga_oil_mod_XOR4XAZLTX {
    other_data: i32,
    the_array: array<u32>,
}
...
@group(2) @binding(1) 
var<storage> rts: RtsStructX_naga_oil_mod_XOR4XAZLTX;
@group(2) @binding(2) 
