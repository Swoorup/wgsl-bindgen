...
impl OverlayRenderer {
    pub fn new(device: &wgpu::Device, surface_format: wgpu::TextureFormat) -> Self {
        ...
        let bind_group_entries = overlay::WgpuBindGroup0Entries::new(
            overlay::WgpuBindGroup0EntriesParams {
    ...
    pub fn update_help_text(&mut self, _device: &wgpu::Device, queue: &wgpu::Queue, text: String) {
        // Generate new texture data
        let texture_data = simple_text::create_text_texture(&text, simple_text::TEXTURE_WIDTH - 20);
    ...
    pub fn update_info(&self, queue: &wgpu::Queue, demo_index: u32, total_demos: u32, elapsed_time: f32, scale_factor: f32, window_width: f32, window_height: f32) {
