...
// SourceHash: abeec3d4123fe919b871a487131794ec0bd4718b5a0e141aed2105e1bb6066e5
...
impl ShaderEntry {
  ...
  pub fn create_shader_module_relative_path(
    ...
    match self {
      ...
      Self::BufferLayouts => buffer_layouts::create_shader_module_relative_path(
        device,
        base_dir,
        shader_defs,
        load_file,
  ...
  pub fn relative_path(&self) -> &'static str {
    match self {
      ...
      Self::BufferLayouts => buffer_layouts::SHADER_ENTRY_PATH,
    }
  }
...
pub mod buffer_layouts {
  ...
  pub struct FixedLayout {
    ...
    pub _pad_primary: [u8; 16 - ::core::mem::size_of::<glam::Vec3>()],
    #[doc = "offset: 16, size: 32, type: `array<vec3<f32>, 2>`"]
    pub accents: [Padded<4usize, glam::Vec3>; 2],
    #[doc = "offset: 48, size: 4, type: `u32`"]
    pub tag: u32,
    pub _pad_tag: [u8; 16 - ::core::mem::size_of::<u32>()],
  }
  impl FixedLayout {
    pub const fn new(primary: glam::Vec3, accents: [glam::Vec3; 2], tag: u32) -> Self {
      Self {
        primary,
        _pad_primary: [0; 16 - ::core::mem::size_of::<glam::Vec3>()],
        accents: pad_array(accents),
        tag,
  ...
  impl FixedLayoutInit {
    pub fn build(&self) -> FixedLayout {
      FixedLayout {
        ...
        _pad_primary: [0; 16 - ::core::mem::size_of::<glam::Vec3>()],
        accents: pad_array(self.accents),
        tag: self.tag,
        _pad_tag: [0; 16 - ::core::mem::size_of::<u32>()],
      }
    }
  ...
  #[doc = r" Widens each element of a fixed-size array to its WGSL array stride."]
  #[doc = r""]
  #[doc = r" `[T; N]::map` is not callable from a `const fn` on stable, so this"]
  #[doc = r" loops instead. Only ever called with `COUNT >= 1`, since WGSL"]
  #[doc = r" fixed-size arrays cannot be empty."]
  #[doc(hidden)]
  ...
  mod __wgsl_bindgen_padded_layout {
    #[doc = r" Marks a `Padded` instantiation whose layout is known to match its"]
    #[doc = r" WGSL array stride, which is what makes the `bytemuck` impls below"]
    #[doc = r" sound."]
    #[doc = r""]
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = r" Implementors must contain no implicit Rust padding and must have a"]
    #[doc = r" size exactly equal to the stride of the WGSL array they represent."]
    #[doc = r" Every implementation is emitted next to a `const` assertion that"]
    #[doc = r" checks this, so do not implement this trait by hand."]
  ...
  const _: () = {
    assert!(
      ::core::mem::size_of::<glam::Vec3>() + 4usize == 16usize,
      "Rust array element size does not match its WGSL stride",
    );
    assert!(
      ::core::mem::size_of::<Padded<4usize, glam::Vec3>>() == 16usize,
      "Padded contains implicit Rust padding or has the wrong stride",
    );
  };
  unsafe impl __wgsl_bindgen_padded_layout::Valid for Padded<4usize, glam::Vec3> {}
  #[repr(C, align(16))]
  #[derive(Debug, PartialEq, Clone, Copy)]
  pub struct RuntimeLayout<Tail = [glam::Vec4]>
  where
    Tail: WgslBindgenRuntimeArray<glam::Vec4> + ?Sized,
  {
  ...
  pub type RuntimeLayoutSized<const N: usize> = RuntimeLayout<[glam::Vec4; N]>;
  impl<const N: usize> RuntimeLayoutSized<N> {
    pub const fn new_sized(header: FixedLayout, colors: [glam::Vec4; N]) -> Self {
      Self { header, colors }
    }
    pub fn as_bytes(&self) -> &[u8]
    where
      FixedLayout: bytemuck::Pod,
      glam::Vec4: bytemuck::Pod,
    {
  ...
  impl RuntimeLayout {
    pub fn new(header: FixedLayout, colors: &[glam::Vec4]) -> Box<Self>
    where
      glam::Vec4: bytemuck::Pod,
    {
      ...
      let __wgsl_bindgen_tail_size = colors
        .len()
        .checked_mul(mem::size_of::<glam::Vec4>())
      ...
      unsafe {
        ...
        let __wgsl_bindgen_tail = ptr::slice_from_raw_parts_mut(
          __wgsl_bindgen_allocation.cast::<glam::Vec4>(),
          colors.len(),
        );
        ...
        ptr::copy_nonoverlapping(
          colors.as_ptr(),
          ptr::addr_of_mut!((*__wgsl_bindgen_this).colors).cast::<glam::Vec4>(),
          colors.len(),
        );
...
"#;
  pub const SHADER_ENTRY_PATH: &str = "buffer_layouts.wgsl";
  pub fn create_shader_module_relative_path(
    device: &wgpu::Device,
    base_dir: &str,
    shader_defs: std::collections::HashMap<String, naga_oil::compose::ShaderDefValue>,
    ...
    let mut composer = naga_oil::compose::Composer::default()
      .with_capabilities(wgpu::naga::valid::Capabilities::from_bits_retain(9u64));
    let module = ShaderEntry::BufferLayouts
      .load_naga_module_from_path(base_dir, &mut composer, shader_defs, load_file)
      .map_err(|e| naga_oil::compose::ComposerError {
        inner: naga_oil::compose::ComposerErrorInner::ImportNotFound(e, 0),
        source: naga_oil::compose::ErrSource::Constructing {
